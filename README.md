<div align="center"> 🧱 <img align="center" width=350 src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opengl/opengl-original.svg" />_C3 aumente o tamanho da fonte 🧱</div>
...
def setup_line(line_points):
    ...
    for x, y in line_points:
        ...
        line_vertices.append(y_normalized)  # Ad
```
Inicialização:
